...
import { 
  ...
  MapPin, Award, FileText, ArrowLeft, LogOut, CheckCircle, RefreshCw
} from "lucide-react";
        ...
        <div className="lg:col-span-5 flex flex-col items-center justify-start gap-4">
          ...
          <div className="w-full max-w-sm grid grid-cols-2 gap-3 mt-2">
            <div className="bg-slate-950/30 border border-slate-900 p-4 rounded-xl text-center">
              ...
              <span className="text-[9px] text-slate-600 block mt-0.5">কোনো পেনাল্টি পয়েন্ট নেই</span>
            </div>
            <div className="bg-slate-950/30 border border-slate-900 p-4 rounded-xl text-center">
          ...
          >
                ...
                <form onSubmit={handleSave} className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      />
                      <span className="text-[9px] text-slate-600 mt-1 block">* নিরাপত্তা জনিত কারণে নাম পরিবর্তন সম্ভব নয়।</span>
                    </div>

                    <div>
                      <label className="block text-[10px] font-bold text-slate-500 uppercase mb-1">ইউজার আইডি (User ID)</label>
                      <input 
                        type="text" 
                        disabled 
            ...
            <div className="mt-8 border-t border-slate-900 pt-4 flex gap-3 items-center bg-slate-900/10 p-3 rounded-xl">
              ...
              <p className="text-[10px] text-slate-500 leading-snug">
                আপনার লাইসেন্স কার্ড ও ট্রাফিক ডাটা সরাসরি সরকারি স্মার্ট ডাটা নেটওয়ার্কের সাথে সংযুক্ত রয়েছে। যেকোনো ভায়োলেশন হলে লাইভ ড্যাশবোর্ডে তা স্বয়ংক্রিয়ভাবে আপডেট হবে।
              </p>
            </div>
          </motion.div>
        </div>
