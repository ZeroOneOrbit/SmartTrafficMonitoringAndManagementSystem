...
const Header = ({ searchTerm, setSearchTerm, setActiveTab }) => {
  ...
  useEffect(()=>{
    const officer= JSON.parse(sessionStorage.getItem('officer'))
    console.log("from header ",officer.name)
      ...
      <div className="flex items-center justify-between md:justify-end gap-6">
        ...
        <div className="relative">
          ...
          >
            ...
            <div className="flex flex-col text-left">
              <span className="text-xs font-bold text-white leading-tight">{adminName}</span>
              <span className="text-[9px] text-blue-400 font-bold uppercase tracking-widest">{adminRole}</span>
            </div>
