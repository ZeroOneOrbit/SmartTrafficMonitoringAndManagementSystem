      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-8 px-3 py-10 sm:grid-cols-2 lg:grid-cols-4 sm:px-6">
        ...
        <div>
          ...
          <div className="mt-4 flex gap-4 text-cyan-400">
            <Globe2 className="cursor-pointer hover:text-white" size={18} />
            <SendHorizontal className="cursor-pointer hover:text-white" size={18} />
            <Code2 className="cursor-pointer hover:text-white" size={18} />
          </div>
        </div>
