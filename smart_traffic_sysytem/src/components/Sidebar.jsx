...
import { 
  LayoutDashboard, Map, TrafficCone, Video, 
  AlertTriangle, Siren, BarChart3, Users, 
  Settings, Power, ShieldAlert, User
} from "lucide-react";
import toast from "react-hot-toast";

const Sidebar = ({ activeTab, setActiveTab, emergencyMode, setEmergencyMode }) => {
  const navigate = useNavigate();

  const menuItems = [
    { id: "dashboard", label: "ড্যাশবোর্ড", icon: LayoutDashboard },
    { id: "map", label: "রিয়েলটাইম ম্যাপ", icon: Map },
    { id: "signals", label: "ট্রাফিক সিগন্যাল", icon: TrafficCone },
    { id: "cctv", label: "সিসিটিভি মনিটরিং", icon: Video },
    { id: "incidents", label: "ঘটনা ব্যবস্থাপনা", icon: AlertTriangle },
    { id: "emergency", label: "জরুরি যানবাহন", icon: Siren },
    { id: "analytics", label: "রিপোর্ট ও অ্যানালিটিক্স", icon: BarChart3 },
    { id: "users", label: "ব্যবহারকারী ব্যবস্থাপনা", icon: Users },
    { id: "admin-profile", label: "আমার প্রোফাইল", icon: User },
  ...
  const handleEmergencyToggle = () => {
    ...
    if (nextState) {
      ...
      toast.success("জরুরি মোড নিষ্ক্রিয় করা হয়েছে। স্বাভাবিক ট্রাফিক প্রোটোকল পুনঃস্থাপিত হয়েছে।", {
        style: {
          background: "#1e293b",
          color: "#34d399",
  ...
  return (
    <div className="w-full max-w-[280px] flex flex-col justify-between h-full bg-slate-950/70 border border-blue-950/40 p-4 rounded-3xl backdrop-blur-xl relative overflow-hidden">
      ...
      {/* Bottom Emergency Button & Status */}
      <div className="mt-6 pt-4 border-t border-slate-900 space-y-4">
        ...
        >
          <ShieldAlert size={16} className={emergencyMode ? "animate-spin" : ""} />
